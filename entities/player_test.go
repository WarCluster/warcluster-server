...
func TestDatabasePreparations(t *testing.T) {
	player := Player{"gophie", "asdf", "planet.0_0", "pngURL", []int{1, 1}, []int{2, 2}}
	expected_json := "{\"TwitterID\":\"asdf\",\"HomePlanet\":\"planet.0_0\",\"AvatarURL\":\"pngURL\",\"ScreenSize\":[1,1],\"ScreenPosition\":[2,2]}"
...
func TestDeserializePlayer(t *testing.T) {
	var player *Player
	serialized_player := []byte("{\"TwitterID\":\"asdf\",\"HomePlanet\":\"planet.3_4\",\"AvatarURL\":\"pngURL\",\"ScreenSize\":[1,1],\"ScreenPosition\":[2,2]}")
